...
class DiskPatternGenerator():
    ...
    def apply_jitter(self, positions, image_size, mean_distance, cv_distance):
        """
    ...
    def generate_disk(
        ...
        norm_factor = self.compute_area_normalization_factor(disk, center, base_radius, global_area_normalization_factor)
    ...
    def adjust_mean_distance_for_uniform_hex_grid(self, image_size, target_distance, max_rows=1000, max_cols=1000, tolerance=0.01):
        """
    ...
    def adjust_mean_distance_for_uniform_square_grid(self, image_size, target_distance, max_rows=1000, max_cols=1000, tolerance=0.01):
        """
    ...
    def generate_square_grid(self, image_size, mean_distance):
        """
    ...
    def generate_hex_grid_with_filter(self, image_size, mean_distance):
        """
    ...
    def build_parallel_stripes(self, positions, image_size, stripe_angle_deg, mean_length, std_length):
        """
    ...
    def export_metadata(self, positions, radii, parameters, stripe_metadata=None, output_dir=cfg.CPG_OUTPUT_DIR):
    ...
    def draw_sinusoidal_stripe(self, img, p1, p2, radius, amplitude, wavelength, n_points=100):
        """
    ...
    def plot_periodic_neighbor_distances(self, positions, image_size, mean_distance, k=6):
        """
